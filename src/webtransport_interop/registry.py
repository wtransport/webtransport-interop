...
from webtransport_interop.endpoints.clients.firefox import FirefoxClient
...
SCENARIO_REGISTRY: dict[str, type[BaseScenario]] = {"devious_baton": DeviousBatonScenario, "echo": EchoScenario}
